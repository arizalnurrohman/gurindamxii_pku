                                    ...
                                    <div class="row">
                                        ...
                                        <div class="box col-xs-8">
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control search-query" placeholder="Masukan Judul materi" name="search" value="{{($data['search']? $data['search']: '')}}">
                            ...
                            <div class="widget-body">
                                ...
                                <div class="row" style="padding:5px; background-color:white; margin-left:0px !important; margin-right:0px !important;">
                                        ...
                                        @if(count($data['data']) > 0)
                                            ...
                                            @endphp
                                            <div class="col-xs-6 col-sm-3 colx_{{($makey+1)}}" style="margin-bottom:10px;vertical-align:top">
                                                <?php /*<label class="pos-rel">
                                                    <input type="checkbox" class="ace">
                                                    <span class="lbl"></span>
                                                </label> */ ?>
                                                <img src="{{asset('storage/images/assets_pengetahuan/'.$maval->pgImage)}}" width="100%">
                                            </div>
                                            <div class="col-xs-6 col-sm-9  colx_{{($makey+1)}}" style="margin-bottom:10px;border-bottom:dashed 1px #5E1362;position: relative">
                                                <div class="row">
                                                    <div class="col-xs-12">
                                                    ...
                                                    <div class="col-xs-12" style="font-size:12px;text-align:right;bottom:0px;position:absolute;bottom: 8px;">
                                                        <form method="POST" class="delete-form" data-route="{{route('riwayat_baca.destroy',$maval->paId)}}" style="display:inline" onCLick="return confirm('Apakah anda yakin akan menghapus data ??')">
                                                            @csrf
                                                            @method('DELETE')
