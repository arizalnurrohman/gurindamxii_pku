...
<div class="col-xs-12">
        ...
        <form class="form-horizontal" role="form" method="post" action="{{route('pengetahuan_category.store')}}" id="pengetahuan_category">
            @csrf
            <div class="form-group">
            	<label class="col-sm-1 control-label no-padding-right" for="form-field-1">Nama Kategori	</label>
                <div class="col-sm-11">
                    <input type="text" name="pername" id="form-field-1" placeholder="Nama Kategori" class="col-xs-10 col-sm-12"/>
                </div>
            </div>
          	<div class="form-group">
