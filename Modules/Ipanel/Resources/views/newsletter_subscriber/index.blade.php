    ...
    <table class="table table-striped table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <i class="fa fa-at bigger-120"></i>: <strong>{{$daval->nsubEmail}}</strong><br>
                    <i class="fa fa-clock-o bigger-120"></i>: <em style="font-size:12px;"><strong>{{date("d M Y H:i:s",strtotime($daval->created_at))}} WIB</strong></em><br>
                    <i class="fa fa-street-view bigger-120"></i>: <em>{{$daval->name}}</em><br>
                </td>
