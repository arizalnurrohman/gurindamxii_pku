                ...
                <div class="login__forms">
                    <form method="POST" action="{{ route('register') }}" class="login__create" id="login-up">
                        ...
                        <div class="login__box">
                            ...
                            <input type="text" placeholder="Nama" name="name" class="login__input  @error('name') is-invalid @enderror"  value="{{ old('name') }}" required autocomplete="name" autofocus>
                        </div>
                        @error('name')
                        ...
                        <div class="login__box">
                            ...
                            <input type="text" placeholder="Email" name="email" class="login__input  @error('email') is-invalid @enderror"  value="{{ old('email') }}" required autocomplete="email">
                        </div>
                        @error('email')
                            <span class="invalid-feedback" role="alert" style="font-size:12px; color:red; display:block;padding:3px;">
                                <strong>{{ $message }}</strong>
                        ...
                        <div class="login__box">
                            ...
                            <input type="password" name="password" placeholder="Password" class="login__input  @error('password') is-invalid @enderror" required autocomplete="new-password">
                        </div>
                        @error('password')
                            <span class="invalid-feedback" role="alert" style="font-size:12px; color:red; display:block;padding:3px;">
                                <strong>{{ $message }}</strong>
                        ...
                        <?php /*<a href="#" class="login__button">Mendaftar</a>*/ ?>

                        <div>
                            <span class="login__account">Sudah memiliki Akun ?</span>
                            <a href="{{ route('login') }}"><span class="login__signup" id="sign-in">Log In</span></a>
                        </div>

                        <?php /*<div class="login__social">
